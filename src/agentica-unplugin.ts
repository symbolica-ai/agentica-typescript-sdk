import magicFunTransformer from '@transformer/transformer';
        ...
        async transform(code: string, id: string) {
            try {
                ...
                if (debug) {
                    ...
                    const magicCallMatch = scriptContent.match(/magic[^(]*\([^)]*\)/);
                    if (magicCallMatch) {
                        console.log(`[unplugin-agentica] Magic call found:`, magicCallMatch[0]);
                    }
                ...
                // Get our transformer
                const transformer = magicFunTransformer(program);
